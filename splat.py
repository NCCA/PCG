...
def splat( x, y, r, g, b, splat_size=10, flow=10):
    for i in range(random.randint(10, 10 + flow)):
        ...
        put_pixel(x + rx, y + ry, r + r_var, g + g_var, b + b_var)
...
def create_images(number=1, width=200, height=200, base_name="test"):
    for i in range(0, number):
        ...
        for _ in range(0, random.randint(100, 200)):
            ...
            for t in np.arange(0, 1, random.uniform(0.01, 0.1)):
        ...
        save(f"{base_name}.{i:04}.png")


if __name__ == "__main__":
    create_images(10, width=400, height=400, base_name="NewSplat")
